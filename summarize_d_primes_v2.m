...
summary_results_path='/imaging/rcusack/laura_ffa_diffusion/temp_summary_results';
...
diary(fullfile(summary_results_path,'summarize_d_primes_v2_diary.txt'));

for groupind=1:length(grouplist)
    switch grouplist{groupind}
        case 'adults'
            adult_s2t=load(fullfile(summary_results_path,'adult_s2t_v3'));
            seedresults=adult_s2t.a2a_seedresults;
        case 'infants'
            infant_s2t=load(fullfile(summary_results_path,'trainadult_testinfant_v3.mat'));
