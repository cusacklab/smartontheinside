...
for r in {181..360}; do
    wb_command -label-to-volume-mapping /home/chiaracaldinelli/smartonetheinside/smartontheinside/ROIs/ROI.${roi}.L.label.gii /home/chiaracaldinelli/smartontheinside/smartontheinside/Q1-Q6_RelatedParcellation210.L.midthickness_MSMAll_2_d41_WRN_DeDrift.32k_fs_LR.surf.gii ${tmp_dir}/T1w_acpc_dc.nii.gz ${tmp_dir}/ROIs/ROI.${roi}.nii -nearest-vertex 1
    done
