...
# DLPFC mask
for hem in L R ; do
    wb_command -label-to-volume-mapping /home/chiaracaldinelli/smartontheinside/ROIs/frontal.${hem}.label.gii ${tmp_dir}/${SUBJ}.${hem}.midthickness_MSMAll.32k_fs_LR.surf.gii ${tmp_dir}/Diffusion.bedpostX/nodif_brain_mask.nii.gz ${tmp_dir}/frontal.${hem}.nii -nearest-vertex 1
    done
# ROIs
mkdir ${tmp_dir}/ROIs/
for roi in {1..180}; do
    wb_command -label-to-volume-mapping /home/chiaracaldinelli/smartontheinside/ROIs/ROI.${roi}.R.label.gii ${tmp_dir}/${SUBJ}.R.midthickness_MSMAll.32k_fs_LR.surf.gii ${tmp_dir}/Diffusion.bedpostX/nodif_brain_mask.nii.gz ${tmp_dir}/ROIs/ROI.${roi}.nii -nearest-vertex 1
    done
for roi in {181..360}; do
    wb_command -label-to-volume-mapping /home/chiaracaldinelli/smartontheinside/ROIs/ROI.${roi}.L.label.gii ${tmp_dir}/${SUBJ}.L.midthickness_MSMAll.32k_fs_LR.surf.gii ${tmp_dir}/Diffusion.bedpostX/nodif_brain_mask.nii.gz ${tmp_dir}/ROIs/ROI.${roi}.nii -nearest-vertex 1
    done
...
aws s3 cp ${tmp_dir}/frontal.L.nii s3://smartontheinside/HCP_1200/$SUBJ/T1w/frontal.L.nii
aws s3 cp ${tmp_dir}/frontal.R.nii s3://smartontheinside/HCP_1200/$SUBJ/T1w/frontal.R.nii