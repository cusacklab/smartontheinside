...
print(f'Working on {sub} directory {LOCAL_DOWNLOAD_PATH}')
...
print(f'Output uploaded to s3://smartontheinside/Results/{sub}_infants_tractography_results_VOXEL_L.npy')
...
print(f'Output uploaded to s3://smartontheinside/Results/{sub}_infants_tractography_results_VOXEL_R.npy')
