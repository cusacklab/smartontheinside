...
diary(fullfile(figpth,'trainadult_testadult_diary_v3.txt'));
...
save('/imaging/rcusack/laura_ffa_diffusion/temp_summary_results/adult_s2t_v3.mat','s2t','a2a_seedresults')
