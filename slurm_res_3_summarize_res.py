...
for sub in range(nsub):
    ...
    f = open(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_ROI.txt',"w")
    f.write( str(roi_res) )
    f.close()

    f = open(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_VOXEL.txt',"w")
    f.write( str(vox_res) )
    f.close()

    #np.save((f'/home/chiaracaldinelli/smartontheinside/{subjlist[sub]}_tractography_results_ROI.txt'), roi_res)
    #np.save((f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_VOXEL.txt'), vox_res)
    s3.upload_file(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_ROI.txt', 'smartontheinside', f'HCP_1200/{subjlist[sub]}/T1w/Diffusion.probtrackx2/{subjlist[sub]}_tractography_results_ROI.txt')
    s3.upload_file(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_VOXEL.txt', 'smartontheinside', f'HCP_1200/{subjlist[sub]}/T1w/Diffusion.probtrackx2/{subjlist[sub]}_tractography_results_VOXEL.txt')
    os.remove(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_ROI.txt')
    os.remove(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_VOXEL.txt')