...
for sub in range(nsub):
    ...
    #f = open(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_ROI.npy',"w")
    #f.write( str(roi_res) )
    #f.close()

    #f = open(f'/home/chiaracaldinelli/{subjlist[sub]}_tractography_results_VOXEL.npy',"w")
    #f.write( str(vox_res) )
    #f.close()
