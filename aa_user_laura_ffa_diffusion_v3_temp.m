...
% Standard stuff, could go in local config gile
...
% aap.tasksettings.aamod_norm_noss_diffusion_session.subject(end+1) = struct('name', '2014_04_01_9003', 'affineStartingEstimate', [-1.5 -19 9 0.2 0 0]);
% 
